...
import com.gaming.core.other.SignatureNotFoundException
...
internal object ApkUtil {
    ...
    fun getCommentLength(fileChannel: FileChannel?): Long {
        ...
        val maxCommentLength =
            Math.min(archiveSize - ZIP_EOCD_REC_MIN_SIZE, UINT16_MAX_VALUE.toLong())
        ...
        for (expectedCommentLength in 0..maxCommentLength) {
            ...
            if (byteBuffer.getInt(0) == ZIP_EOCD_REC_SIG) {
                ...
                if (actualCommentLength == expectedCommentLength) {
                    return actualCommentLength.toLong()
                }
            }
        }
